	...
	$cfg = [
		...
		'fields' => [
			...
			'apiKey' => [
				...
				'Type' => 'text',
				'Size' => '65',
				'Description' => 'Your developer API KEY. This is the account API key and not the projects API key. You can find it by clicking on your profile link in the bottom left corner.',
			],
			'minConfidence' => [
		...
		Capsule::schema()
			->create(
				...
				function ($table) {
					...
					$table->text('client_session_id');
					$table->text('backend_session_id');
